"""
Input new methods into this file to throughly test them with possibility of breakpoints in the code.



!!!!! Please write here what is inside the test method so people don't have to guess !!!!!
custom_timed.py
